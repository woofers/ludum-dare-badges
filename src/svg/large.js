...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="454" height="363" version="1.1">
  ...
  <g transform="translate(30, 138) scale(0.032, 0.032)" fill="#d0d0d8" >
    <use href="#overall" />
    <use href="#fun" y="775"/>
    <use href="#innovation" y="1600"/>
    <use href="#theme" y="2450"/>
    <use href="#graphics" y="3300"/>
    <use href="#audio" y="4125"/>
  ...
  <text x='61' y='126' font-size='16px' text-anchor='left' fill="#d0d0d8">
    <tspan x='61' dy='1.63em'>${it.stats[0].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[1].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[2].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[3].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[4].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[5].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[6].category}</tspan>
    <tspan x='61' dy='1.63em'>${it.stats[7].category}</tspan>
  </text>

  <!-- Placement -->
  <text x='153' y='126' font-size='16px' text-anchor='left' fill="#d0d0d8">
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[0].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[0].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[1].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[1].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[2].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[2].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[3].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[3].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[4].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[4].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[5].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[5].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[6].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[6].ith}</tspan></tspan>
    <tspan x='153' dy='1.63em'><tspan font-weight="bold">${it.stats[7].grade}</tspan><tspan font-size="12px" baseline-shift="super">${it.stats[7].ith}</tspan></tspan>
  </text>

  <!-- Ratings -->
  <text x='207' y='126' font-size='16px' text-anchor='left' fill="#d0d0d8">
    <tspan x='207' dy='1.63em'>${it.stats[0].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[1].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[2].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[3].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[4].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[5].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[6].average}</tspan>
    <tspan x='207' dy='1.63em'>${it.stats[7].average}</tspan>
  </text>
</svg>
`
